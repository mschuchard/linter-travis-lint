  ...
  provideLinter() {
    return {
      ...
      lint: async (textEditor) => {
        ...
        const args = ['lint', '--no-interactive', '--skip-version-check', '--skip-completion-check'];
          ...
          .catch(error => {
            ...
            if (matchesYaml != null) {
              toReturn.push({
                ...
                location: {
                  file,
                  position: [[Number.parseInt(matchesYaml[2], 10) - 1, Number.parseInt(matchesYaml[3], 10) - 1], [Number.parseInt(matchesYaml[2], 10) - 1, Number.parseInt(matchesYaml[3], 10)]],
                },
              });
            } else {
